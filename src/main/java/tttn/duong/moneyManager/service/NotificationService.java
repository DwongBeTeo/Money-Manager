...
//    @Scheduled(cron = "0 * * * * *", zone = "Asia/Ho_Chi_Minh")//1p la gui 1 mail
    @Scheduled(cron = "0 0 22 * * *", zone = "Asia/Ho_Chi_Minh")//22h tối hằng ngày theo giờ việt
    public void sendDailyIncomeExpenseReminder() {
        ...
        for (ProfileEntity profile:profiles){
            ...
            emailService.sendEmail(profile.getEmail(),"DailyReminder: Add your income and expense", body);
        }
