package tttn.duong.moneyManager.config;
...
import tttn.duong.moneyManager.security.JwtRequestFilter;
import tttn.duong.moneyManager.service.AppUserDetailsService;
...
public class SecurityConfig__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<SecurityConfig> getSecurityConfigInstanceSupplier() {
    return BeanInstanceSupplier.<SecurityConfig>forConstructor(AppUserDetailsService.class, JwtRequestFilter.class)
