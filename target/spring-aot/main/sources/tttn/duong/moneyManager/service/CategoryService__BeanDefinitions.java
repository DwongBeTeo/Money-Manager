...
public class CategoryService__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<CategoryService> getCategoryServiceInstanceSupplier() {
    return BeanInstanceSupplier.<CategoryService>forConstructor(ProfileService.class, CategoryRepository.class)
            .withGenerator((registeredBean, args) -> new CategoryService(args.get(0), args.get(1)));
  }
