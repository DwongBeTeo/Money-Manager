...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("tttn.duong.moneyManager.entity.CategoryEntity", "tttn.duong.moneyManager.entity.ExpenseEntity", "tttn.duong.moneyManager.entity.IncomeEntity", "tttn.duong.moneyManager.entity.ProfileEntity");
